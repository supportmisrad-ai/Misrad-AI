        ...
        contents: [
          {
            ...
            parts: [
              ...
              {
                text: 'תמלל את האודיו הזה בדיוק כפי שנאמר בעברית.\nחובה: הוסף timestamp בפורמט [MM:SS] בתחילת כל שורה/משפט חדש לפי הזמן בהקלטה.\nאם יש יותר מדובר אחד, זהה את הדוברים השונים וסמן כל החלפת דובר בשורה חדשה עם תגית: "דובר 1:", "דובר 2:", וכו\'.\nדוגמה לפורמט:\n[00:00] דובר 1: שלום, מה שלומך?\n[00:05] דובר 2: תודה, בסדר גמור.\nאל תסכם, אל תתקן - רק תמלול מדויק עם זיהוי דוברים ו-timestamps.',
              },
            ],
          },
        ],
