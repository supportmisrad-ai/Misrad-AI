            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-slate-900/50 border border-slate-800 rounded-2xl p-6">
                    <div className="flex items-center justify-between mb-6">
                        <h3 className="text-lg font-bold text-white flex items-center gap-2"><Target size={20} className="text-emerald-500" /> עסקאות חמות</h3>
                        <button className="text-xs text-emerald-400 hover:text-emerald-300 font-bold">לכל העסקאות</button>
                    </div>
