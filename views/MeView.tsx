...
function coerceLeaveRequest(value: unknown): LeaveRequest {
  ...
  return {
    ...
    start_date: obj.startDate ?? obj.start_date ? String(obj.startDate ?? obj.start_date) : undefined,
    end_date: obj.endDate ?? obj.end_date ? String(obj.endDate ?? obj.end_date) : undefined,
...
export const MeView: React.FC<{
  ...
  // Compute elapsed IMMEDIATELY from activeShift — no waiting for interval tick
  ...
  // Update currentTime every second for elapsed + daily stats
  useEffect(() => {
