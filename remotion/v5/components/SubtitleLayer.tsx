...
import { V5, HEEBO, SUBTITLE_TRACK } from '../config';

export const SubtitleLayer: React.FC = () => {
  const frame = useCurrentFrame();

  const current = SUBTITLE_TRACK.find((s) => frame >= s.from && frame < s.to);
  ...
  const blurIn = interpolate(localFrame, [0, 15], [6, 0], {
    extrapolateRight: 'clamp',
  });
    ...
    >
      <div
        style={{
          ...
          border: `1px solid ${V5.primary}30`,
