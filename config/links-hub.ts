...
export const LINKS_HUB: HubLink[] = [
  ...
  { id: 'm-the-operator', title: 'Landing · The Operator', href: '/the-operator', category: 'שיווק' },
  { id: 'm-the-closer', title: 'Landing · The Closer', href: '/the-closer', category: 'שיווק' },
  { id: 'm-the-authority', title: 'Landing · The Authority', href: '/the-authority', category: 'שיווק' },
  { id: 'm-the-empire', title: 'Landing · The Empire', href: '/the-empire', category: 'שיווק' },
  { id: 'm-solo', title: 'Landing · Solo', href: '/solo', category: 'שיווק' },
