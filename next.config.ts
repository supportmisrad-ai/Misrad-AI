        ...
        headers: [
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://img.clerk.com https://*.clerk.dev https://images.clerk.dev https://clerk.misrad-ai.com https://*.googleusercontent.com https://images.unsplash.com https://*.supabase.co",
