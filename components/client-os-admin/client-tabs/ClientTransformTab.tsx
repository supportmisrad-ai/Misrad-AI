      ...
      {client.transformations?.map((trans) => (
        <div key={trans.id} className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
          <div className="flex justify-between items-start mb-6">
            ...
            {trans.isPublished && (
              <span className="text-[10px] bg-green-50 text-green-600 px-2 py-1 rounded font-bold uppercase tracking-wide">פורסם</span>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
            ...
            <div className="bg-gray-50 rounded-xl p-5 border border-gray-100">
              ...
              <div className="mb-4 h-40 bg-gray-200 rounded-lg overflow-hidden relative">
                ...
                <div className="absolute bottom-2 right-2 bg-black/50 text-white text-[10px] px-2 py-1 rounded backdrop-blur-sm">{trans.before.emotionalState}</div>
              </div>
            ...
            <div className="bg-nexus-primary/5 rounded-xl p-5 border border-nexus-primary/10">
              ...
              <div className="mb-4 h-40 bg-gray-200 rounded-lg overflow-hidden relative shadow-lg">
                {trans.after.mediaUrl ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center text-white bg-nexus-accent">
                    <Star size={32} />
                  </div>
                )}
                <div className="absolute bottom-2 right-2 bg-nexus-primary text-white text-[10px] px-2 py-1 rounded backdrop-blur-sm font-bold shadow-glow-gold">{trans.after.emotionalState}</div>
              </div>
