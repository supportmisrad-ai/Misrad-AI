                    ...
                    <td className="p-6 align-top">
                      {isEditing ? (
                        <div className="grid grid-cols-2 gap-2">
                          ...
                          <div className="col-span-2 mt-2 rounded-xl border border-violet-200 bg-violet-50 px-3 py-2">
                            <div className="text-[10px] font-black text-violet-700">🕎 סגור בשבת (שינוי בדף פרטי ארגון בלבד)</div>
                          </div>
                        </div>
                      ) : (
                        <div className="flex flex-wrap gap-2">
                          ...
                          <span className="px-2 py-1 rounded-lg text-[9px] font-black bg-violet-100 text-violet-700">
                            {org.is_shabbat_protected === false ? 'שבת: פטור רפואי' : 'שבת: סגור'}
                          </span>
                        </div>
                      )}
                    </td>
