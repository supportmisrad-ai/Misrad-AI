      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
        {[
          ...
          { 
            ...
            trend: metrics?.trends?.subscriptions ? `${metrics.trends.subscriptions > 0 ? '+' : ''}${metrics.trends.subscriptions}` : '+0', 
            icon: Users, 
            color: 'text-blue-400' 
          },
          { 
            ...
            trend: metrics?.trends?.overdue ? `${metrics.trends.overdue > 0 ? '+' : ''}${metrics.trends.overdue}%` : '0%', 
            icon: ShieldCheck, 
            color: 'text-red-400' 
          },
          { 
