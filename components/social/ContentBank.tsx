        ...
        <motion.section initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <div className="bg-white p-8 md:p-10 rounded-3xl md:rounded-[48px] border border-slate-200 shadow-xl">
            <div className="flex items-center justify-between mb-8">
              ...
              <button className="bg-slate-900 text-white px-5 py-2.5 rounded-xl font-black text-xs flex items-center gap-2 hover:bg-slate-800 transition-all shadow-lg">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <button className="aspect-square rounded-3xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-300 hover:border-blue-400 hover:text-blue-500 transition-all gap-2">
                <Upload size={32} />
          ...
          <div className="bg-white p-8 md:p-10 rounded-3xl md:rounded-[48px] border border-slate-200 shadow-xl">
            <div className="flex items-center justify-between mb-8">
              ...
              >
                ...
                {showAddHashtagForm ? 'ביטול' : 'סט חדש'}
              </button>
            </div>
