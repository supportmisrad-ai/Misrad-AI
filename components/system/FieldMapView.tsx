  ...
  return (
    <div className="flex-1 flex flex-col p-4 md:p-8 max-w-[1920px] mx-auto animate-fade-in pb-24 min-h-0">
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
        ...
        <h2 className="text-2xl font-black text-slate-800 mb-2">צוותי שטח</h2>
        <p className="text-slate-500 text-sm max-w-md mb-6">
          מעקב חי, ביקורים ומסלולים לצוותי שטח. הפיצ׳ר בפיתוח ויהיה זמין בקרוב.
        </p>
        <div className="flex items-center gap-2 bg-rose-50 text-rose-700 px-5 py-2.5 rounded-xl text-sm font-bold border border-rose-100">
          <Rocket size={16} />
          בקרוב
        </div>
      </div>
