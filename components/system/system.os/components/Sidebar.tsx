...
import { Target, X, Layout, Building2, Cpu, Wallet, Map, Megaphone, BarChart3, Kanban, Users } from 'lucide-react';
...
const Sidebar = React.memo(({ activeTab, setActiveTab, user, logout: _logout, mobile = false, onClose }: SidebarProps) => {
    ...
    >
      ...
      <div className="px-6 pb-8 pt-4 border-t border-slate-100">
         <div className="flex items-center gap-4 p-4 rounded-[32px] bg-slate-50 border border-slate-200 shadow-sm transition-all group overflow-hidden">
            <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-sm font-bold text-slate-700 border border-slate-200 shadow-sm shrink-0 overflow-hidden">
                {hasValidAvatarSrc ? (
