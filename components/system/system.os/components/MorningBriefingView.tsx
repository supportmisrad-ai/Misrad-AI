                              ...
                              <div className="flex justify-between items-start mb-3">
                                  <div className="flex items-center gap-3">
                                      ...
                                      <div>
                                          ...
                                          <div className="text-[10px] font-black text-rose-500 uppercase tracking-widest">{lead.score} SCORE</div>
                                      </div>
                                  </div>
                                  <span className="font-mono font-bold text-slate-900">₪{lead.value.toLocaleString()}</span>
                              </div>
