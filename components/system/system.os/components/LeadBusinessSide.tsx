...
import { Lead, SquareActivity, PipelineStage } from '../types';
...
const LeadBusinessSide: React.FC<LeadBusinessSideProps> = ({ lead, onClose, onAddActivity, onStatusChange, onOpenClientPortal }) => {
    ...
    return (
        <>
            ...
            {showProposalModal && <ProposalModal lead={lead} onClose={() => setShowProposalModal(false)} onSend={(p) => addToast('הצעה נשלחה', 'success')} />}
