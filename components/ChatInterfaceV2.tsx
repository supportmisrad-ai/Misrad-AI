            ...
            <div className="flex gap-3 items-end">
              <div className="flex-1 relative">
                <textarea
                  ...
                  className="w-full px-5 py-4 border-2 border-slate-200 rounded-3xl focus:outline-none focus:border-blue-400 resize-none min-h-[56px] max-h-[120px] text-[16px] leading-relaxed"
                  disabled={isLoading}
                  dir="rtl"
                  rows={1}
                />
