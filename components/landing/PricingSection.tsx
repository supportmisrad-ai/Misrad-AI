...
const PACKAGES: { 
  ...
  roi: string;
    ...
    { 
      key: 'solo', 
      emoji: '🎯', 
      label: 'כלי אחד ספציפי', 
      who: 'מי שצריך פתרון לבעיה אחת כואבת', 
      price: 149, 
      modules: 'Nexus בלבד', 
      freeUsers: 1,
      bullets: [
        ...
        'מי עושה מה ומתי',
        'סנכרון מלא לצוות',
        'AI שמתמצת מה קרה היום'
      ],
      roi: 'סגירת משימה אחת שחוסכת שעה בשבוע — והחזרת את ההשקעה.'
    },
    { 
      key: 'the_closer', 
      emoji: '💼', 
      label: 'מכונות מכירה', 
      who: 'מוקדי מכירות וסוכנים שרוצים לסגור יותר', 
      price: 249, 
      ...
      roi: 'סגירת ליד אחד נוסף בחודש — והחזרת את ההשקעה פי 5.'
    },
    { 
      key: 'the_authority', 
      emoji: '🎨', 
      label: 'נוכחות ושיווק', 
      who: 'יוצרי תוכן ועסקים שצריכים פוסטים ולקוחות', 
      price: 349, 
      modules: 'Social + Client + Nexus', 
      freeUsers: 1,
      bullets: [
        'פוסטים שעולים לבד לרשתות',
        'יצירת תוכן ב-AI בקליק',
        'ניהול מועדון לקוחות',
        'סדר במשימות השיווק'
      ],
      roi: 'חיסכון של 10 שעות כתיבה ועיצוב בחודש — זה הכסף שלך בחזרה.'
    },
    { 
      key: 'the_operator', 
      emoji: '🔧', 
      label: 'תכלס עבודה (שטח)', 
      who: 'חברות אחזקה, קבלנים וצוותי שטח', 
      price: 349, 
      modules: 'Operations + Nexus', 
      freeUsers: 1,
      bullets: [
        'דיווח מהשטח בלחיצה',
        'סידור מסלולים חכם לעובדים',
        'מעקב מיקום וביצוע בזמן אמת',
        'ניהול צוותים גדולים'
      ],
      roi: 'מניעת "שעות מתות" בצוות השטח — החזר השקעה מהיום הראשון.'
    },
    { 
      key: 'the_empire', 
      emoji: '👑', 
      ...
      freeUsers: 5,
      bullets: [
        'כל מה שיש למערכת להציע',
        'סנכרון מלא בין מכירות לתפעול',
        'AI שרואה את כל התמונה',
        '5 משתמשים כלולים במחיר'
      ],
      roi: 'שליטה מלאה בארגון ומניעת כפילויות עבודה — חיסכון של אלפי שקלים בחודש.'
    },
  ];
        ...
        <div className="max-w-3xl mx-auto">
          <div className="relative rounded-[2rem] border-2 border-indigo-200 bg-gradient-to-br from-white via-indigo-50/20 to-purple-50/20 shadow-2xl shadow-indigo-100/40 overflow-hidden">
            ...
            <div className="p-6 sm:p-8 md:p-10">
              ...
              {/* ROI Note */}
              <div className="flex items-center gap-3 px-5 py-4 rounded-2xl bg-emerald-50 border-2 border-emerald-100 mb-6">
                <TrendingUp className="text-emerald-600" size={20} />
                <div className="text-sm">
                  <span className="font-black text-emerald-900 block mb-0.5">תכלס ROI:</span>
                  <span className="text-emerald-800 font-medium">{pkg.roi}</span>
                </div>
              </div>
