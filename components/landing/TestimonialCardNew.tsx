...
export const TestimonialCardNew = ({ name, role, company, text, image, color = "indigo" }: TestimonialCardNewProps) => {
    ...
    return (
        <div className="min-w-[350px] md:min-w-[400px] bg-[#0F1117] p-6 rounded-2xl border border-slate-800 hover:border-slate-700 transition-colors mx-4 relative overflow-hidden group">
            ...
            <p className="text-slate-300 text-base leading-relaxed mb-6 font-medium">"{text}"</p>
