            ...
            <div className="relative z-10 space-y-8 flex-1">
              ...
              <div className="pt-6 border-t border-white/5">
                ...
                <div className="flex justify-between items-end">
                  <span className="text-2xl font-bold">{client.hoursLogged} <span className="text-sm text-slate-500 font-normal">שעות נוצלו</span></span>
                ...
                {client.invoices?.map((inv: Invoice) => (
                  <tr key={inv.id} className="hover:bg-slate-50 transition-colors group">
                    ...
                    <td className="px-6 py-5 text-left">
                      <button className="p-2 text-slate-300 hover:text-nexus-primary transition-colors"><Download size={18}/></button>
                    </td>
                  </tr>
                ))}
              </tbody>
