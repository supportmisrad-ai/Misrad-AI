      ...
      <div className="animate-slide-up space-y-6 pb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2 glass-card p-4 md:p-6 rounded-2xl border-l-4 border-l-nexus-primary relative overflow-hidden flex flex-col gap-6">
                  ...
                  <div>
                      <div className="flex justify-between items-start mb-4 gap-2">
                          ...
                          <div className={`text-lg md:text-xl font-bold px-3 py-2 rounded-xl border whitespace-nowrap ${analysisResult?.sentimentScore && analysisResult.sentimentScore > 70 ? 'bg-green-50 text-green-600 border-green-200' : 'bg-yellow-50 text-yellow-600 border-yellow-200'}`}>
              ...
              <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="glass-card p-4 rounded-xl flex items-center justify-between">
                      <div className="flex items-center gap-3">
                          <div className="p-2 bg-amber-50 text-amber-600 rounded-lg"><Lightbulb size={18}/></div>
                          <span className="font-bold text-gray-700">בהירות</span>
                      </div>
                      <div className="flex items-center gap-2">
                          <div className="w-16 md:w-24 h-2 bg-gray-100 rounded-full overflow-hidden"><div className="bg-amber-600 h-full" style={{width: `${analysisResult?.rating?.clarity}%`}}></div></div>
