                ...
                <div key={fb.id} className="bg-white border border-gray-200 p-5 rounded-xl shadow-sm">
                    <div className="flex justify-between items-start mb-3">
                        ...
                        <div className="flex gap-1">
                            {fb.keywords.map(k => <span key={k} className="text-[10px] bg-gray-100 text-gray-500 px-1.5 py-0.5 rounded">#{k}</span>)}
                        </div>
                    </div>
                    <p className="text-gray-700 italic text-sm border-r-2 border-gray-200 pr-3">
                        "{fb.comment}"
                    </p>
                </div>
            ))}
