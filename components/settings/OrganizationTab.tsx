                    ...
                    <div>
                        <div className="flex items-start justify-between gap-4">
                            <div className="min-w-0 flex-1">
                                <div className="text-sm font-bold text-gray-900">מצב עצמאי (פרילנסר)</div>
                                <div className="text-xs text-gray-500 mt-1">מציג מסך מוקטן ללא ניהול צוות — מיועד לעובדים בודדים. לא משפיע על הנתונים.</div>
                            </div>
                            <button
                                type="button"
                                onClick={() => {
                                    ...
                                    setSoloMode(next);
                                    addToast(next ? 'מצב עצמאי הופעל' : 'מצב עצמאי בוטל', 'success');
                                }}
