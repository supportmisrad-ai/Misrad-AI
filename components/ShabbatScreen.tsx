  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id="shb-velvet" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#0B1022" />
          <stop offset="0.6" stopColor="#151B34" />
          <stop offset="1" stopColor="#090D1B" />
        </linearGradient>
        <radialGradient id="shb-candleGlow" cx="50%" cy="35%" r="70%">
        ...
        <radialGradient id="shb-candleGlow2" cx="50%" cy="20%" r="80%">
          <stop offset="0" stopColor="#FFBA42" stopOpacity="0.4" />
          <stop offset="1" stopColor="#FFBA42" stopOpacity="0" />
        </radialGradient>
        <filter id="shb-softShadow" x="-20%" y="-20%" width="140%" height="140%">
        ...
        <filter id="shb-flameGlow" x="-50%" y="-50%" width="200%" height="200%">
      ...
      {/* Candle outer glows */}
      <circle cx="330" cy="130" r="90" fill="url(#shb-candleGlow2)" />
      <circle cx="390" cy="130" r="90" fill="url(#shb-candleGlow2)" />

      {/* Candle inner glows */}
      <circle cx="330" cy="150" r="70" fill="url(#shb-candleGlow)">
        <animate attributeName="r" values="68;72;68" dur="2.5s" repeatCount="indefinite" />
        <animate attributeName="opacity" values="0.9;1;0.9" dur="2.5s" repeatCount="indefinite" />
      </circle>
      <circle cx="390" cy="150" r="70" fill="url(#shb-candleGlow)">
      ...
      {/* Kiddush cup */}
      <g filter="url(#shb-softShadow)">
        <path d="M650 190 C 650 165, 700 165, 700 190 L 690 250 C 686 270, 664 270, 660 250 Z" fill="url(#shb-gold)" />
        <path d="M662 252 C 660 290, 690 290, 688 252" fill="url(#shb-gold)" opacity="0.9" />
        <rect x="655" y="290" width="40" height="10" rx="5" fill="url(#shb-gold)" opacity="0.9" />
      ...
      <g filter="url(#shb-softShadow)">
        ...
        <rect x="244" y="156" width="22" height="10" rx="5" fill="url(#shb-gold)" />
      </g>
