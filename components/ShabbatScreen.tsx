/**
 * Shabbat Screen Component
 * 
 * Displays a beautiful Shabbat screen when the system is in Shabbat mode
 */
...
function ShabbatTableIllustration() {
  return (
    ...
    >
      <defs>
        <linearGradient id="shb-gold" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#F6E6B4" />
          <stop offset="0.5" stopColor="#D4AF37" />
          <stop offset="1" stopColor="#FFF4CC" />
        </linearGradient>
        <linearGradient id="shb-goldV" x1="0" y1="0" x2="0" y2="1">
      ...
      <path d="M70 300 Q 400 230 730 300 L 720 340 Q 400 390 80 340 Z" fill="url(#shb-cloth)" opacity="0.12" />
      <ellipse cx="400" cy="300" rx="310" ry="38" fill="none" stroke="url(#shb-gold)" strokeWidth="2" opacity="0.5" />
      <ellipse cx="400" cy="300" rx="290" ry="32" fill="none" stroke="url(#shb-gold)" strokeWidth="1" opacity="0.2" />

      {/* === WINE BOTTLE (left) === */}
      <g filter="url(#shb-shadow)" transform="translate(145,0)">
        {/* Bottle neck */}
        <rect x="42" y="115" width="16" height="50" rx="4" fill="url(#shb-wineBody)" />
        {/* Bottle cap */}
        <rect x="44" y="108" width="12" height="12" rx="3" fill="url(#shb-gold)" />
        {/* Bottle body */}
        <path d="M34 165 C 34 158 42 155 42 155 L 42 165 Q 30 180 28 220 Q 26 260 50 290 Q 74 260 72 220 Q 70 180 58 165 L 58 155 C 58 155 66 158 66 165" fill="url(#shb-wineBody)" />
        {/* Wine color visible through body */}
        <path d="M36 200 Q 34 240 50 278 Q 66 240 64 200 Q 56 190 50 190 Q 44 190 36 200" fill="url(#shb-wine)" opacity="0.7" />
        {/* Label */}
      ...
      <g transform="translate(280,0)">
        {/* Candle holder base */}
        <ellipse cx="50" cy="290" rx="24" ry="6" fill="url(#shb-goldV)" opacity="0.8" />
        <rect x="34" y="278" width="32" height="14" rx="4" fill="url(#shb-cup)" />
        <rect x="40" y="268" width="20" height="14" rx="3" fill="url(#shb-cup)" />
        <ellipse cx="50" cy="270" rx="12" ry="4" fill="url(#shb-gold)" opacity="0.6" />
        {/* Candle body */}
        <rect x="42" y="155" width="16" height="118" rx="8" fill="url(#shb-candle)" />
        <path d="M44 160 L 44 268" stroke="#FFFFFF" strokeWidth="1" opacity="0.2" />
        {/* Large glow */}
        <circle cx="50" cy="120" r="80" fill="url(#shb-glow2)" opacity="0.5">
          <animate attributeName="r" values="78;84;78" dur="3s" repeatCount="indefinite" />
        </circle>
        {/* Inner glow */}
        <circle cx="50" cy="130" r="40" fill="url(#shb-glow1)">
      ...
      {/* === CHALLAH (center, between candles) === */}
      <g filter="url(#shb-shadow)" transform="translate(340, 248)">
        {/* Shadow */}
        <ellipse cx="60" cy="42" rx="65" ry="14" fill="#000" opacity="0.15" />
        {/* Challah cover (white cloth) */}
        <path d="M-10 38 Q 60 22 130 38 Q 125 48 60 50 Q -5 48 -10 38" fill="#F8F5EF" opacity="0.4" />
        {/* Main challah body */}
        <ellipse cx="60" cy="28" rx="58" ry="22" fill="url(#shb-challah)" />
        {/* Braiding pattern - 3 strands */}
      ...
      {/* === KIDDUSH CUP (right) === */}
      <g filter="url(#shb-shadow)" transform="translate(565,0)">
        {/* Cup base */}
        <ellipse cx="50" cy="296" rx="28" ry="7" fill="url(#shb-goldV)" />
        <rect x="30" y="288" width="40" height="10" rx="5" fill="url(#shb-cup)" />
        {/* Cup stem */}
        <rect x="44" y="248" width="12" height="42" rx="4" fill="url(#shb-cup)" />
        <ellipse cx="50" cy="250" rx="8" ry="3" fill="url(#shb-gold)" opacity="0.5" />
        {/* Cup bowl */}
        <path d="M24 195 C 24 170 76 170 76 195 L 72 248 C 68 256 32 256 28 248 Z" fill="url(#shb-cup)" />
        {/* Wine inside cup */}
            ...
            <div className="relative px-6 sm:px-10 md:px-14 py-10 md:py-14">
              <div className="flex flex-col items-center gap-8 text-center">
                ...
                <div className="grid w-full grid-cols-1 gap-4 sm:grid-cols-2">
                  <CountdownDisplay 
                    label="צאת הכוכבים" 
                    value={formatShabbatTime(shabbatTimes.shabbatEnd)} 
                    accent 
                  />
                  <CountdownDisplay 
                    label="זמן עד צאת הכוכבים" 
                    value={timeUntilEnd || '—'} 
                  />
                </div>
                ...
                >
                  ...
                  <span className="text-xs font-bold text-[#F8F1D6]/40 tracking-wide">
