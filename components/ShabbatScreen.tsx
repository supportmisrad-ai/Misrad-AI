  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-[#05060B] via-[#0B1022] to-[#05060B] text-[#F8F1D6]" dir="rtl">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-5xl flex-col items-center justify-center px-6 py-16">
        <div className="w-full rounded-[36px] border border-[#D4AF37]/25 bg-white/5 p-8 shadow-[0_40px_120px_-60px_rgba(212,175,55,0.55)] backdrop-blur-xl md:p-10">
          <div className="flex flex-col items-center gap-6 text-center">
            ...
            <div className="w-full rounded-3xl border border-[#D4AF37]/20 bg-[#0B1022]/45 px-7 py-6 text-center">
