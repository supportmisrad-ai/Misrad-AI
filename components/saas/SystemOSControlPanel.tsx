...
const SYSTEM_OS_SCREENS = [
    ...
    { id: 'mkt_content', label: 'תוכן', category: 'marketing' },
    { id: 'mkt_forms', label: 'טפסים', category: 'marketing' },
    { id: 'mkt_partners', label: 'שותפים', category: 'marketing' },
    { id: 'finance', label: 'כספים', category: 'operations' },
    { id: 'operations', label: 'תפעול', category: 'operations' },
    { id: 'reports', label: 'דוחות', category: 'headquarters' },
    { id: 'headquarters', label: 'ניהול', category: 'headquarters' },
...
export const SystemOSControlPanel: React.FC<SystemOSControlPanelProps> = ({ organization, updateSystemFlag }) => {
    return (
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
            <div className="mb-8">
                <h1 className="text-4xl font-black text-white tracking-tight mb-2 bg-gradient-to-r from-white via-red-200 to-rose-200 bg-clip-text text-transparent">
                    בקרת מערכת System
                </h1>
                <p className="text-slate-400 text-lg">שליטה על סטטוס מסכי System (פעיל / תחזוקה / מוסתר) עבור כל המשתמשים.</p>
            </div>
