...
export const ComprehensivePricingPanel: React.FC<{ hideHeader?: boolean }> = ({ hideHeader }) => {
    ...
    function getDefaultPlans(): LandingPagePlan[] {
        return [
            ...
            { id: 'system_single', system: 'system', name: getModuleLabelHe('system'), subtitle: 'מודול בודד (משתמש אחד)', systemSubtitle: 'לידים ומכירות', priceMonthly: 149, priceYearly: 119, features: ['משתמש אחד (ללא ניהול צוות)', 'ניהול לידים + Pipeline מכירות', 'מרכז תקשורת + חייגן מרכזיית ענן', 'Follow Up', 'תמיכה בעברית'], recommended: true, order: 0, isActive: true },
