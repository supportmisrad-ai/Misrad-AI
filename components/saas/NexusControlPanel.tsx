...
export const NexusControlPanel: React.FC<NexusControlPanelProps> = ({ organization, updateSystemFlag }) => {
    return (
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
            <div className="mb-8">
                ...
                <p className="text-slate-400 text-lg">שליטה על סטטוס מסכי Nexus (פעיל / תחזוקה / מוסתר) עבור כל המשתמשים.</p>
            </div>
