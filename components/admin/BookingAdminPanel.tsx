...
export function BookingAdminPanel({ orgSlug, initialData, children }: BookingAdminPanelProps) {
  ...
  const tabs: Array<{
  ...
  }> = useMemo(() => [
    {
      ...
      label: 'יומן',
      icon: Calendar,
      path: `/app/admin/booking?tab=calendar`,
    },
    {
      id: 'appointments',
      label: 'תורים',
      ...
      path: `/app/admin/booking?tab=appointments`,
    },
    {
      id: 'providers',
      label: 'נותני שירות',
      ...
      path: `/app/admin/booking?tab=providers`,
    },
    {
      id: 'services',
      label: 'שירותים',
      ...
      path: `/app/admin/booking?tab=services`,
    },
    {
      id: 'links',
      label: 'לינקים',
      ...
      path: `/app/admin/booking?tab=links`,
    },
    {
      id: 'settings',
      label: 'הגדרות',
      icon: Settings,
      path: `/app/admin/booking?tab=settings`,
    },
  ], [initialData, orgSlug]);
