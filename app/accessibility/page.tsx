...
export default async function AccessibilityPage() {
  const result = await getContentByKey('legal', 'documents', 'accessibility_markdown');
              ...
              <>
                ...
                <div className="mt-10 space-y-4">
                  <div className="rounded-2xl bg-white border border-slate-200 shadow-xl shadow-slate-200/50 p-6">
                    ...
                    <div className="mt-2 text-sm text-slate-600">לפניות בנושא נגישות אפשר לפנות דרך דף יצירת קשר.</div>
                    <div className="mt-4">
                      <Link
                        href="/contact"
