...
export function mapTimeEntryRow(row: unknown): TimeEntry {
  ...
  return {
    ...
    startLat: toNumberMaybe(obj.start_lat ?? obj.startLat),
    startLng: toNumberMaybe(obj.start_lng ?? obj.startLng),
    startAccuracy: toNumberMaybe(obj.start_accuracy ?? obj.startAccuracy) ?? null,
    endLat: toNumberMaybe(obj.end_lat ?? obj.endLat),
    endLng: toNumberMaybe(obj.end_lng ?? obj.endLng),
