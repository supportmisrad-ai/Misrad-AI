      ...
      <main className="pt-24">
        <section className="relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 py-16 sm:py-20 relative">
            ...
            <h1 className="mt-6 text-4xl sm:text-5xl font-black leading-tight">מדיניות החזרים וזיכויים</h1>
            {markdown ? (
              ...
              <>
                ...
                <div className="mt-10 space-y-4">
                  <div className="rounded-2xl bg-white border border-slate-200 shadow-xl shadow-slate-200/50 p-6">
                    ...
                    <div className="mt-2 text-sm text-slate-600">לבקשות בנושא החזרים וזיכויים אפשר לפנות דרך דף יצירת קשר.</div>
                    <div className="mt-4">
                      <Link
                        href="/contact"
