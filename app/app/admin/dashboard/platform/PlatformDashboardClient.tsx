    ...
    <div className="space-y-6 pb-24" dir="rtl">
      ...
      <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-2xl border border-green-200 p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-600">כל המערכות פועלות תקין</p>
          </div>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          ...
          <div className="bg-white rounded-2xl p-3 md:p-4">
            <p className="text-xs md:text-sm text-slate-500">שרתים פעילים</p>
          ...
          <div className="bg-white rounded-2xl p-3 md:p-4">
            <p className="text-xs md:text-sm text-slate-500">Cache Status</p>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-4 md:p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-slate-500">סה"כ בקשות (24h)</p>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-4 md:p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-slate-500">זמן תגובה ממוצע</p>
              <p className="text-3xl font-bold text-slate-900 mt-1">{stats.avgResponseTime}ms</p>
            </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-4 md:p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-slate-500">שיעור שגיאות</p>
              <p className="text-3xl font-bold text-slate-900 mt-1">{stats.errorRate}%</p>
            </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-4 md:p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-slate-500">חיבורים פעילים</p>
              <p className="text-3xl font-bold text-slate-900 mt-1">{stats.activeConnections}</p>
            </div>
            <div className="p-3 bg-green-100 rounded-2xl">
              <Globe className="w-6 h-6 text-green-600" />
            </div>
          </div>
          <p className="text-xs text-slate-400 mt-2">משתמשים מחוברים כעת</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 md:gap-4">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-4 md:p-6">
          ...
          <p className="text-xs text-slate-400 mt-2">35% מהמכסה</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-4 md:p-6">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-slate-900">{stats.cacheHitRate}%</p>
            </div>
          </div>
          <div className="w-full bg-slate-100 rounded-full h-2">
            <div className="bg-purple-500 h-2 rounded-full" style={{ width: `${stats.cacheHitRate}%` }} />
          </div>
          <p className="text-xs text-slate-400 mt-2">יעילות מצוינת</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-4 md:p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-slate-500">פריסה אחרונה</p>
              <p className="text-2xl font-bold text-slate-900">{getLastDeploymentText()}</p>
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between text-sm mb-2">
              ...
              <span className="font-black text-slate-900">23%</span>
            </div>
          ...
          <div>
            <div className="flex items-center justify-between text-sm mb-2">
              <span className="text-slate-600">זיכרון</span>
              <span className="font-black text-slate-900">64%</span>
            </div>
            <div className="w-full bg-slate-100 rounded-full h-3">
          ...
          <div>
            <div className="flex items-center justify-between text-sm mb-2">
              <span className="text-slate-600">דיסק</span>
              <span className="font-black text-slate-900">41%</span>
            </div>
            <div className="w-full bg-slate-100 rounded-full h-3">
          ...
          <div>
            <div className="flex items-center justify-between text-sm mb-2">
              <span className="text-slate-600">רשת</span>
