    ...
    <div className="space-y-6 pb-24" dir="rtl">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
          ...
          <p className="text-xs text-gray-400 mt-2">בעלי ארגונים</p>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500">סה"כ ארגונים</p>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500">ארגונים פעילים</p>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-yellow-600 mt-1">{stats.trialOrganizations}</p>
            </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="text-xs sm:text-sm text-gray-500 truncate">הרשמות ב-7 ימים</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900">{stats.recentSignups}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xl md:text-2xl font-bold text-orange-600">{stats.expiringTrials}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 md:p-6">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xl md:text-2xl font-bold text-red-600">{stats.canceledOrganizations}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 md:p-6">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="text-xs md:text-sm text-gray-500 truncate">שיעור המרה</p>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">התפלגות סטטוס ארגונים</h3>
        <div className="space-y-3">
          {/* Active */}
          <div>
            <div className="flex items-center justify-between text-sm mb-1">
              <span className="text-gray-600">פעילים</span>
              <span className="font-semibold text-green-600">{stats.activeOrganizations}</span>
            </div>
          ...
          <div>
            <div className="flex items-center justify-between text-sm mb-1">
              ...
              <span className="font-semibold text-yellow-600">{stats.trialOrganizations}</span>
            </div>
            <div className="w-full bg-gray-100 rounded-full h-2">
              <div 
          ...
          <div>
            <div className="flex items-center justify-between text-sm mb-1">
              <span className="text-gray-600">מבוטלים</span>
              <span className="font-semibold text-red-600">{stats.canceledOrganizations}</span>
            </div>
            <div className="w-full bg-gray-100 rounded-full h-2">
              <div 
