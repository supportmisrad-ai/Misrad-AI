  ...
  return (
    <div className="space-y-4">
      <input
        ...
        className="w-full max-w-md px-4 py-2 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-200"
      />
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          {getActiveModules(org).map((mod) => (
            <span
              key={mod}
              className="px-3 py-1 rounded-full bg-indigo-50 text-indigo-700 text-xs font-black"
            >
