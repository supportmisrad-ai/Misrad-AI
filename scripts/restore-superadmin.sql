...
INSERT INTO organizations (id, name, slug, logo, owner_id, has_nexus, has_social, has_system, has_finance, has_client, has_operations, seats_allowed, subscription_plan, subscription_status, trial_days, trial_start_date, trial_end_date, balance, ai_credits_balance_cents, is_shabbat_protected, billing_email, tax_id, mrr, arr, discount_percent, created_at, updated_at) VALUES ('185e7212-23fc-4170-98ca-be3213424fc7', 'Misrad AI HQ', 'misrad-ai-hq', NULL, '8b3d565d-d790-4cdf-88cb-813eb9fd6dde', TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, 10, 'the_empire', 'active', 0, NULL, NULL, '"0"'::jsonb, 0, TRUE, NULL, NULL, '"0"'::jsonb, '"0"'::jsonb, 0, '2026-02-17T12:00:37.852Z', '2026-02-17T12:00:37.852Z') ON CONFLICT (id) DO UPDATE SET
    name = EXCLUDED.name,
    slug = EXCLUDED.slug,
...
INSERT INTO organizations (id, name, slug, logo, owner_id, has_nexus, has_social, has_system, has_finance, has_client, has_operations, seats_allowed, subscription_plan, subscription_status, trial_days, trial_start_date, trial_end_date, balance, ai_credits_balance_cents, is_shabbat_protected, billing_email, tax_id, mrr, arr, discount_percent, created_at, updated_at) VALUES ('e7b3e758-0934-4d1a-b79c-ea2701114a59', 'Test THE CLOSER', 'test-the_closer', NULL, '8b3d565d-d790-4cdf-88cb-813eb9fd6dde', TRUE, FALSE, TRUE, TRUE, FALSE, FALSE, 5, 'the_closer', 'active', 0, NULL, NULL, '"0"'::jsonb, 0, TRUE, NULL, NULL, '"0"'::jsonb, '"0"'::jsonb, 0, '2026-02-17T12:00:40.166Z', '2026-02-17T12:00:40.166Z') ON CONFLICT (id) DO UPDATE SET
    name = EXCLUDED.name,
    slug = EXCLUDED.slug,
    subscription_plan = EXCLUDED.subscription_plan,
    subscription_status = EXCLUDED.subscription_status,
...
INSERT INTO organizations (id, name, slug, logo, owner_id, has_nexus, has_social, has_system, has_finance, has_client, has_operations, seats_allowed, subscription_plan, subscription_status, trial_days, trial_start_date, trial_end_date, balance, ai_credits_balance_cents, is_shabbat_protected, billing_email, tax_id, mrr, arr, discount_percent, created_at, updated_at) VALUES ('424c0ed4-0123-4233-b8f1-a5319b6bffdd', 'Test THE AUTHORITY', 'test-the_authority', NULL, '8b3d565d-d790-4cdf-88cb-813eb9fd6dde', TRUE, TRUE, FALSE, TRUE, TRUE, FALSE, 5, 'the_authority', 'active', 0, NULL, NULL, '"0"'::jsonb, 0, TRUE, NULL, NULL, '"0"'::jsonb, '"0"'::jsonb, 0, '2026-02-17T12:00:40.883Z', '2026-02-17T12:00:40.883Z') ON CONFLICT (id) DO UPDATE SET
    name = EXCLUDED.name,
    slug = EXCLUDED.slug,
    subscription_plan = EXCLUDED.subscription_plan,
    subscription_status = EXCLUDED.subscription_status,
