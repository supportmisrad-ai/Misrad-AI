...
## סצנה 1: HOOK — "כלי אחד. לא 9." [0:00–0:03]
**פריימים: 0–90**

| שנייה | פריימים | מה רואים | אנימציה | קריינות |
|-------|---------|----------|---------|---------|
| 0:00–0:01.5 | 0–45 | **רקע חם עם paper grain.** **5 frosted glass app icons** מפוזרים במסך — כולם מטושטשים, חצי-שקופים, צפים ב-3D space. **Camera dolly דרכם — אף אחד לא בפוקוס.** הכל דחוס, מבולגן, overlapping. **Badge אדום ליד כל אחד:** "₪79" / "₪49" / "₪99" / "₪59" / "₪129". | 5 frosted app icons: float in 3D, blurred, overlapping. Camera: dolly through. Price badges: red, subtle bloom. Chaos. | (SFX: digital clutter — overlapping notifications) |
| 0:01.5–0:03 | 45–90 | **כל 5 ה-icons מתפוררים (disintegration) בו-זמנית.** מאחוריהם: **icon אחד יחיד** — frosted glass, חד, ב-DoF. **"כלי אחד. ₪149."** — brushed brand metal. | Icons: simultaneous disintegration. Behind: single icon materializes, sharp, frosted glass. Text: materializes, brushed metal. Camera: holds. | "כלי אחד. 149 שקל. כל מה שצריך." |

---

## סצנה 2: PROBLEM — "יותר מדי כלים" [0:03–0:10]
**פריימים: 90–300**

| שנייה | פריימים | מה רואים | אנימציה | קריינות |
|-------|---------|----------|---------|---------|
| 0:03–0:06 | 90–180 | **Rack focus** מה-icon → לטלפון. מסך: **home screen עם 9 app icons** — כולם generic. **DoF: רק 3 בפוקוס.** ליד כל אחד: תג מחיר frosted. **"₪487/חודש"** — Slot Machine Roll, אדום, ננעל. | Rack focus: icon→phone. App icons: 9 in grid, most blurred. Price: slot machine roll → lock red. | "9 אפליקציות. 487 שקל בחודש. ואף אחת לא מדברת עם השנייה." |
| 0:06–0:08 | 180–240 | **Rack focus shift** בין apps — כל אחד שנכנס לפוקוס מתחיל **disintegration בבוקה** כשיוצא. **מידע שמתפורר בין הכלים.** | Rack focus shifts between apps. Each exiting: edge disintegration in bokeh. Data crumbling between tools. | "נתונים מפוזרים. כל אפליקציה — עולם סגור. שום דבר לא מחובר." |
| 0:08–0:10 | 240–300 | **Camera pulls back.** Frosted overlay. **"₪487 בחודש. על בלגן."** — brushed red metal. | Dolly out. Frosted overlay. Text: materializes red brushed metal. | "487 שקל בחודש. על בלגן." |

---

## סצנה 3: SOLUTION — "מודול אחד" [0:10–0:22]
**פריימים: 300–660**
...
## סצנות 7+8: TAGLINE + CTA [0:50–1:00]
...
## שוני v2:
1. **הוק = 5 frosted apps שמתפוררים → כלי אחד** — not app grid with counter
2. **₪487 = Slot Machine Roll אדום** — not accelerating counter
...
10. **Slot Machine Roll** על כל מספר
